...
from ficct_dashboard_api.avatar_views import AvatarAskView, AvatarLlmTokenView, AvatarTtsTokenView
...
urlpatterns = [
    ...
    path('avatar/llm-token/', AvatarLlmTokenView.as_view(), name='avatar-llm-token'),
]
